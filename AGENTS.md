...
| **MODE=PATCH** | Мінімальний фікс | ≤150 LOC, ≤1 новий файл, без нових concurrency patterns. VERIFY + POST |
| **MODE=ADR** | Зміна інваріантів/контрактів | ADR документ: проблема → рішення → інваріанти → exit criteria → rollback |
