...
MAX_CALLS_DEFAULT = 30  # get_history (діб) за прогін; логінів — див. DAYS_PER_SESSION_DEFAULT
MAX_CALLS_CEILING = 300
# Одна дитина = один логін FXCM на пакет діб одного символу: власник не приймає ~1000 логінів за вихідні, а
# частоту логінів брокера не виміряно. Кожна доба — окремий get_history у тій самій сесії під власним дедлайном;
...
KILL_WAIT_S = 15
CALL_INTERVAL_DEFAULT_S = 5  # пауза між сесіями (логінами); нуль заборонено — частоту логінів не виміряно
