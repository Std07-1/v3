...
| [0069](ADR-0069-narrative-panel-state-aware.md) | NarrativePanel — State-Aware Modes (Compact / Banner / Expanded) | **Accepted** (with 2 Open Decisions §A backend signal, §B banner color + override stickiness) | 2026-05-09 | NarrativePanel, 3-mode state machine, agent_state, premium real-estate rule, sessionStorage override, mobile sheet, ADR-0033 dependency, R3, M3→M4 | `chrome_polish_v1` |
