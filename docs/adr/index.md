...
Наступний номер: **0080** (0079 зайнято: Drawing Tools Delicate Object Interaction, ADR-0079; 0078 зайнято: Drawing Tools Right-Click Grammar, ADR-0078; 0077 зайнято: Drawing Toolbar Redesign V2, ADR-0077; 0076 зайнято: Unified Auth Gate, ADR-0076). Зарезервовано (кандидати на 0080+): **Drawing Tools поверхня-2 — ліва панель** (right-click на іконці → колір/товщина/стиль, frosted flyout); **P3 Детач/перетягування drawing-toolbar** (per-icon drag + edge-magnetism + safe-zone clamp + mobile guard); **Cross-TF drawing sync** + **draw-into-future** (ADR-0079 §Future work). Раніше свіжо-зайняті: 0058 Public Read-Only API, 0059 (Withdrawn) Public Analysis API, 0060 Deploy Discipline, 0061 VPS Reconciliation, 0062 Major Bump Playbook, 0063 TypeScript 6, 0064 Price-Axis Single Owner, 0065 (rev1/rev2) Command Rail, 0066 Visual Identity, 0068 Brand Surface, 0069 NarrativePanel, 0070 TR Corner, 0071 PWA Standalone, 0072 Mobile Canonical, 0073 Price Scale, 0074 Drawing Tools V1). Зарезервовано: NarrativeSheet (mobile Архі-surface, forward-ref у ADR-0073 rev 2) — кандидат на 0076 (0075 зайнято: WakeEngine Bar-Close Kinds, ADR-0075).
