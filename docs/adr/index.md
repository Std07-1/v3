...
| [0073](ADR-0073-price-scale-overlay.md) | Price Scale Overlay — Custom Canvas Labels for Edge-to-Edge Candles | **Proposed** | 2026-05-11 | Hide LWC `rightPriceScale.visible:false`, render periodic price labels + last-value chip + crosshair price label via 3 new methods in OverlayRenderer.ts, reclaim ~44px chart width on all viewports, edge-to-edge candle rendering, on acceptance amends ADR-0072 (☰ moves right:44→8), shifts NarrativeSheet forward-ref to ADR-0074, R3, M3→M4 | `chart_overlay_v1` |
