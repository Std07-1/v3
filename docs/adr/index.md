...
| [0070](ADR-0070-tr-corner-canonical.md) | Новий кут (TR area) Canonical Contract — CommandRail + NP scope, X28-fix, wording, click-outside | **Accepted** | 2026-05-09 | CommandRail X28-fix (frame.atr backend SSOT, RV removed, wallclock countdown), NP = pure Арчi-surface (no system narrative), liveness via thesis.freshness, canonical wording (`Арчі` + literal status map), click-outside-collapse, locks 9 commits 491ab73→a9b66cc as canonical reality, R3, M3→M4 | `chrome_polish_v1` |
