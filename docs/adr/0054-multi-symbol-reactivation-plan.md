...
- **Статус**: **Accepted (rev 6)** — rev 6 (2026-09-24): «го» власника — EUSTX50 (вимкнений 21.09, був у FIRST_TICK) повертається і GER30 (W4) активується в PREVIOUS_CLOSE: засів/ремонт M1 з архіву брокера з 02.03.2026 (settle ADR-0098), нативний D1 з 2012/1990 (ADR-0103), похідні на сезонній сітці (ADR-0095 S7); активація — окремим комітом config.symbols у вікні щоденної перерви, лише якщо потік EU чистий. rev 5 (2026-09-17): W5 EUSTX50 активовано (шостий символ), §3.8 п.2 (`has_range`) закрито патчем на проді, календарні групи EU розділені за виміряними годинами; W4 GER30 готовий і чекає вікна. rev 4 (2026-09-10): §3.8 п.1 (сліпий D1-вимір) закрито; решта блокерів відкриті. rev 3: Фази 0-2 закриті, §3.6 закрито, W1/W2 виконані, додано §3.8.
...
| W4 | **GER30** | `cfd_eu_ger30` | 🟢 **АКТИВАЦІЯ 24.09.2026** у вікні щоденної перерви (rev 6): M1 з архіву PREVIOUS_CLOSE з 02.03, D1 натив з 1990, похідні S7; репетиція на копії проду — усі VERIFY 0, D1 = натив 9138 діб |
| W5 | **EUSTX50** | `cfd_eu_eustx50` | 🟢 **ПОВЕРНЕННЯ 24.09.2026** (rev 6): активовано 17.09 у FIRST_TICK, вимкнено 21.09; тепер M1 PREVIOUS_CLOSE з 02.03 (89 609 замін, 13 070 вставок у репетиції), D1 натив з 2012 (3601 доба = натив), похідні S7 |
