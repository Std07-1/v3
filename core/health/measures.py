...
class ChainResult:
    ...
    Межа між ними — календар символу. На статичному літньому календарі (до сезонного ADR-0095 S6) зимові денна
    перерва і відкриття вихідних (22:00–22:59 UTC) мають «торгові» хвилини без барів, тож зимові розриви на них
    лічаться в ``at_gap``, а не в ``inner``.
...
def check_anchor_on_session_edge(
    ...
    *,
    ...
    статичному літньому календарі (до сезонного ADR-0095 S6) — перша хвилина після перерви (вмикається).
