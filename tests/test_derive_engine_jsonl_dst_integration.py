...
@pytest.mark.parametrize("start_ms, end_ms, must_have_h4, must_have_d1, phantom_h4", [
    pytest.param(  # весна: пт 06.03 зима (22/02/…) → пн 09.03 літо (21/01/…)
        _ms(2026, 3, 5, 22), _ms(2026, 3, 9, 10),
        [_ms(2026, 3, 6, 18), _ms(2026, 3, 8, 21), _ms(2026, 3, 9, 1), _ms(2026, 3, 9, 5)],
        [_ms(2026, 3, 5, 22)],
        [_ms(2026, 3, 8, 22), _ms(2026, 3, 9, 2)],  # зимова сітка після переходу
        id="spring-2026-03-08",
    ),
    pytest.param(  # осінь: пт 30.10 літо (21/01/…) → пн 02.11 зима (22/02/…)
        _ms(2026, 10, 29, 21), _ms(2026, 11, 2, 10),
        [_ms(2026, 10, 30, 17), _ms(2026, 11, 1, 22), _ms(2026, 11, 2, 2), _ms(2026, 11, 2, 6)],
        [_ms(2026, 10, 29, 21)],
        [_ms(2026, 11, 1, 21), _ms(2026, 11, 2, 1)],  # обрубок Нд 21:00 і літня сітка після переходу
        id="fall-2026-11-01",
    ),
])
