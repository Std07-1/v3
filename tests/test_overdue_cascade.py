...
class TestOverdueDataFrontier:
    ...
    def test_bucket_waits_while_its_last_minute_is_beyond_the_data_frontier(self) -> None:
        ...
        engine = DeriveEngine(symbols=[sym], anchor_offset_s=0, calendars={sym: _WeekdayCalendar()},
    ...
    def test_symbol_without_frontier_keeps_clock_behaviour(self) -> None:
        sym = "TEST/SYM"
        engine = DeriveEngine(symbols=[sym], anchor_offset_s=0, cascade_tfs_s={300}, commit_tfs_s={300})
